  ...
  <div class="onBoarding">
    <md-whiteframe class="onBoarding__container">
      <div class="onBoarding__box">
        ...
        <md-input-container class="onBoarding__inputBlock">
          <md-input
            ...
            id="onBoarding__bandName"
            v-model="credentials.bandName"
          ></md-input>
          <label
            class="onBoarding__label"
            for="onBoarding__bandName"
            required
          >
            Your band's name
          </label>
        ...
        <md-input-container class="onBoarding__inputBlock">
          <md-input
            class="onBoarding__input"
            id="onBoarding__bandSocialUrl"
            v-model="credentials.bandSocialUrl"
          ></md-input>
          <label
            class="onBoarding__label"
            for="onBoarding__bandSocialUrl"
            require
          >
            URL to your band's social media page
          </label>
        </md-input-container>
        ...
        <md-input-container class="onBoarding__inputBlock">
          <md-input
            class="onBoarding__input"
            id="onBoarding__bandPhone"
            v-model="credentials.phone"
          ></md-input>
          <label
            class="onBoarding__label"
            for="onBoarding__conf_pass"
          >
      ...
      <md-button
        ...
        @click="submit(), changeCurrentModal('AddMember')"
      >
        Okay, let's go
      </md-button>
    </md-whiteframe>
